...
if __name__ == "__main__":
	...
	max_sequence_identities_file = open(max_sequence_identities_filename, 'w')
		...
		if (prediction_task == 1):
	                output_filename = output_files_dir + protein_id + '_ss3.struct'

		elif (prediction_task == 2):
	                output_filename = output_files_dir + protein_id + '_ss8.struct'
		elif (prediction_task == 3):
                        output_filename = output_files_dir + protein_id + '_ta5.struct'

		elif (prediction_task == 4):
                        output_filename = output_files_dir + protein_id + '_ta7.struct'

		elif (prediction_task == 5):
                        output_filename = output_files_dir + protein_id + '_sa2.struct'
